...
private val testClasses = listOf(
    KotlinCompilerTraceRecorderJsonTests.Companion,
    KtorTraceRecorderJsonTests.Companion,
)
...
private val testPath = basePath / "src" / "main" / "org" / "jetbrains" / "trace" / "recorder" / "test" / "generated"

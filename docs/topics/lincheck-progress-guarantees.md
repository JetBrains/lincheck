...
```kotlin
```
{src="examples/NonBlockingGuaranteesTests.kt" include-symbol="ConcurrentSkipListMapTest.modelCheckingTest"}
...
2. Create a test class for `ConcurrentHashMap`, declare the `put()` function and a test 
   ...
   ```kotlin
   ```
   {src="examples/NonBlockingGuaranteesTests.kt" include-symbol="ConcurrentHashMapTest"}
...
2. Create a test class for `ConcurrentSkipListMap`, declare the `put()` function and a test function with 
   ...
   ```kotlin
   ```
   {src="examples/NonBlockingGuaranteesTests.kt" include-symbol="ConcurrentSkipListMapTest"}

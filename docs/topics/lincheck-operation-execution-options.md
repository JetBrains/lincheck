...
```kotlin
```
{src="examples/NonParallelGroupTest.kt" include-symbol="NonParallelGroupTest.poll,NonParallelGroupTest.peek,NonParallelGroupTest.offer,NonParallelGroupTest.isEmpty"}
...
```kotlin
```
{src="examples/RunOnceTest.kt" include-symbol="RunOnceTest.singleOp,RunOnceTest.regularOp"}
...
```kotlin
```
{src="examples/NonBlockingGuaranteesTests.kt" include-symbol="ConcurrentHashMapWithBlockingTest.put"}
...
```kotlin
```
{src="examples/CancellableOperationsTests.kt" include-symbol="CancellableOnSuspensionTest.receive"}

Consider the following channel test:

```kotlin
```
{src="examples/CancellableOperationsTests.kt" include-symbol="CancellableOnSuspensionTest"}
...
```kotlin
```
{src="examples/CancellableOperationsTests.kt" include-symbol="PromptCancellationTest.receive"}

Consider the following channel test:

```kotlin
```
{src="examples/CancellableOperationsTests.kt" include-symbol="PromptCancellationTest"}

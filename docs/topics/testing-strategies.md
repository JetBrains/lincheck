...
> * Get the [full code of these examples](https://github.com/JetBrains/lincheck/tree/master/common/src/test-lincheck-integration/org/jetbrains/lincheck_test/guide/CounterTest.kt)
> * See more [test examples](https://github.com/JetBrains/lincheck/tree/master/common/src/test/org/jetbrains/lincheck_test/guide)
>
{style="note"}

 ...
 * #L%
 */
package org.jetbrains.kotlinx.lincheck.test.strategy.randomsearch;
...
public class RandomSearchOptionsTest {
    ...
    @Test
    public void test() {
        Options opts = new RandomSearchOptions()
            .iterations(10)
        ...
        LinChecker.check(RandomSearchOptionsTest.class, opts);
    }
}
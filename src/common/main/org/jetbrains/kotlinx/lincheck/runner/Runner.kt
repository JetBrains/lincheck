...
expect fun Runner.loadClassLoader(): Any
expect fun loadClass(classLoader: Any, testClass: TestClass): TestClass
...
abstract class Runner protected constructor(
    ...
    open fun initialize() {
        ...
        testClass = loadClass(_testClass)
    }
     ...
     */
    private fun loadClass(testClass: TestClass): TestClass = loadClass(classLoader, testClass)

    /**
     * Creates a transformer required for this runner.
     * Throws [UnsupportedOperationException] by default.
     *
     * @param cv should be of type ClassVisitor
     * @return class visitor which transform the code due to support this runner.
     */
    open fun createTransformer(cv: Any): Any? = null

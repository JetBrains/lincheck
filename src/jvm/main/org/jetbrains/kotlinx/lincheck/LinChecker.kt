...
class LinChecker(
    ...
    constructor(testClass: Class<*>, options: Options<*, *>?)
            : this(testClass, CTestStructure.getFromTestClass(testClass), options)
    ...
    init {
        ...
        // so for custom scenarios declared with DSL,
        // we have to set up it when testClass is scanned

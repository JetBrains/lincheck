...
class DSLThreadScenario : ArrayList<Actor>() {
     ...
     */
    @JvmName("actor7")
    fun <T, V, K, M, N, L> actor(
        f: KFunction6<T, V, K, M, N, L, *>,
        arg0: T,
        arg1: V,
        arg2: K,
        arg3: M,
    ...
    fun <T, V, K, M, N, L> actor(
        f: KSuspendFunction6<T, V, K, M, N, L, *>,
        arg0: T,
        arg1: V,
        arg2: K,
        arg3: M,
     ...
     */
    @JvmName("actor8")
    fun <T, V, K, M, N, L, P> actor(
        f: KFunction7<T, V, K, M, N, L, P, *>,
        arg0: T,
        arg1: V,
        arg2: K,
        arg3: M,
    ...
    fun <T, V, K, M, N, L, P> actor(
        f: KSuspendFunction7<T, V, K, M, N, L, P, *>,
        arg0: T,
        arg1: V,
        arg2: K,
        arg3: M,
     ...
     */
    @JvmName("actor9")
    fun <T, V, K, M, N, L, P, S> actor(
        f: KFunction8<T, V, K, M, N, L, P, S, *>,
        arg0: T,
        arg1: V,
        arg2: K,
        arg3: M,
    ...
    fun <T, V, K, M, N, L, P, S> actor(
        f: KSuspendFunction8<T, V, K, M, N, L, P, S, *>,
        arg0: T,
        arg1: V,
        arg2: K,
        arg3: M,
     ...
     */
    @JvmName("actor10")
    fun <T, V, K, M, N, L, P, S, R> actor(
        f: KFunction9<T, V, K, M, N, L, P, S, R, *>,
        arg0: T,
        arg1: V,
        arg2: K,
        arg3: M,
    ...
    fun <T, V, K, M, N, L, P, S, R> actor(
        f: KSuspendFunction9<T, V, K, M, N, L, P, S, R, *>,
        arg0: T,
        arg1: V,
        arg2: K,
        arg3: M,

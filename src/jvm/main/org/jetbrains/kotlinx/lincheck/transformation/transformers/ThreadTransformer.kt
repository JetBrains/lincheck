...
/**
 * Instruments [java.lang.Thread] class and its subclasses by making the thread report itself on [Thread.start] and
 * on finish of [Thread.run] to [EventTracker] instance.
 *
...
internal class ThreadTransformer(
    ...
    override fun visitInsn(opcode: Int) = adapter.run {
        ...
        if (isThreadSubclass && opcode == Opcodes.RETURN && isRunMethod(methodName, desc)) {
            // STACK: <empty>

...
import sun.nio.ch.lincheck.CoroutineInternalCallTracker.isCoroutineInternalClass
import java.io.*
import java.util.*
...
fun isCoroutineStateMachineClass(internalClassName: String) =
    getSuperclassName(internalClassName) == "kotlin/coroutines/jvm/internal/ContinuationImpl"

private class SuperclassClassVisitor : ClassVisitor(ASM_API) {
                ...
                GETSTATIC -> {
                    invokeIfInTestingCode(
                        ...
                        code = {
                            ...
                            push(owner)
                            push(fieldName)
                            push(FinalFields.isFinalField(owner, fieldName))
                            loadNewCodeLocationId()

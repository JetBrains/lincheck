...
class ExecutionScenario(
     ...
     */
    fun hasSuspendableActors(): Boolean {
        return Stream.concat(parallelExecution.stream().flatMap { obj: List<Actor> -> obj.stream() }, postExecution.stream()).anyMatch(Actor::isSuspendable)
    }

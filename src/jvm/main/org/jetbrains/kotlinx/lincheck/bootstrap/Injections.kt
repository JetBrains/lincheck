 ...
 object Injections {
    ...
    fun storeCancellableContinuation(cont: Any) {
        ...
        if (t is TestThread) {
            ...
            lastSuspendedCancellableContinuation = cont
        }
    }
    ...
    @JvmStatic
    fun beforeReadField(obj: Any?, className: String, fieldName: String, isFinal: Boolean, codeLocation: Int) {
        if (obj == null) return // Ignore, NullPointerException will be thrown
        sharedEventsTracker.beforeReadField(obj, className, fieldName, isFinal, codeLocation)
    }

    @JvmStatic
    fun beforeReadFieldStatic(className: String, fieldName: String, isFinal: Boolean, codeLocation: Int) {
        sharedEventsTracker.beforeReadFieldStatic(className, fieldName, isFinal, codeLocation)
    }

...
class DistributedStressStrategy<Message, Log>(
    ...
    private val runner: DistributedStressRunner<Message, Log> =
        DistributedStressRunner(this, testCfg, testClass, validationFunctions, stateRepresentationFunction)

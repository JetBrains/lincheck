...
object TraceRecorder {
    ...
    fun recordTraceInternal(outputFile: String, block: Runnable) {
        ...
        withLincheckJavaAgent(InstrumentationMode.TRACE_RECORDING) {
            ...
            installAndStartTrace(TraceAgentParameters.classUnderTraceDebugging, TraceAgentParameters.methodUnderTraceDebugging, methodDescriptor, TraceAgentParameters.traceDumpFilePath)

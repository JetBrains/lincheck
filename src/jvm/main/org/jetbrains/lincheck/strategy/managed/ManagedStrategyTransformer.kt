...
import org.jetbrains.lincheck.TransformationClassLoader.*
...
private fun isStrategyMethod(className: String) = className.startsWith("org/jetbrains/lincheck/strategy")

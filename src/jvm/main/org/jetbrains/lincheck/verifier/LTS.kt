...
package org.jetbrains.lincheck.verifier

import kotlinx.coroutines.*
import org.jetbrains.lincheck.*
import org.jetbrains.lincheck.CancellableContinuationHolder.storedLastCancellableCont
import org.jetbrains.lincheck.verifier.LTS.*
import org.jetbrains.lincheck.verifier.OperationType.*
import java.util.*
...
class LTS(sequentialSpecification: Class<*>) {
    ...
    private val sequentialSpecification: Class<*> = TransformationClassLoader { cv ->

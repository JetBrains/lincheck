...
class AtomicReferenceFieldUpdaterTest : AbstractLincheckTest() {
    ...
    @Operation
    fun set(newValue: String) = updater.set(this, newValue)

    @Operation
    fun getAndSet(newValue: String) = updater.getAndSet(this, newValue)

    @Operation
    fun compareAndSet(expectedValue: String, newValue: String) = updater.compareAndSet(this, expectedValue, newValue)
}
...
class RendezvousChannelCustomTest : VerifierState() {
    ...
    @Test
    fun testCancellation_01() = withLincheckJavaAgent(STRESS) {
    ...
    @Test
    fun testCancellation_02() = withLincheckJavaAgent(STRESS) {
        verify(RendezvousChannelCustomTest::class.java, LinearizabilityVerifier::class.java, {
            parallel {
                thread {
    ...
    @Test
    fun testCancellation_03() = withLincheckJavaAgent(STRESS) {
        verify(RendezvousChannelCustomTest::class.java, LinearizabilityVerifier::class.java, {
            parallel {
                thread {
    ...
    @Test
    fun testCancellation_04() = withLincheckJavaAgent(STRESS) {
        verify(RendezvousChannelCustomTest::class.java, LinearizabilityVerifier::class.java, {
            parallel {
                thread {
                    operation(actor(sendFun, 1, cancelOnSuspension = true), Cancelled)
    ...
    @Test
    fun testCancellation_05() = withLincheckJavaAgent(STRESS) {
        verify(RendezvousChannelCustomTest::class.java, LinearizabilityVerifier::class.java, {
            parallel {
                thread {

...
class RendezvousChannelCustomTest : VerifierState() {
    ...
    @Test
    fun testCancellation_01() = withLincheckJavaAgent(TransformationMode.STRESS) {
    ...
    @Test
    fun testCancellation_02() = withLincheckJavaAgent(TransformationMode.STRESS) {
        verify(RendezvousChannelCustomTest::class.java, LinearizabilityVerifier::class.java, {
            parallel {
                thread {
    ...
    @Test
    fun testCancellation_03() = withLincheckJavaAgent(TransformationMode.STRESS) {
        verify(RendezvousChannelCustomTest::class.java, LinearizabilityVerifier::class.java, {
            parallel {
                thread {
    ...
    @Test
    fun testCancellation_04()  = withLincheckJavaAgent(TransformationMode.STRESS){
        verify(RendezvousChannelCustomTest::class.java, LinearizabilityVerifier::class.java, {
            parallel {
                thread {
                    operation(actor(sendFun, 1, cancelOnSuspension = true), Cancelled)
    ...
    @Test
    fun testCancellation_05() = withLincheckJavaAgent(TransformationMode.STRESS) {
        verify(RendezvousChannelCustomTest::class.java, LinearizabilityVerifier::class.java, {
            parallel {
                thread {

...
public class CustomScenarioJavaDSLTest {
    ...
    public void shouldBuildMinimalScenario() {
        ...
        assertEquals(0, scenario.getInitExecution().size());
        assertEquals(0, scenario.getParallelExecution().size());
        assertEquals(0, scenario.getPostExecution().size());
    }
    ...
    public void shouldInheritActorParametersFromAnnotation() {
        ...
        assertEquals(expectedActor, scenario.getInitExecution().get(0));
    }

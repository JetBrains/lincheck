...
class InlineLambdaConditionalTakenDeepReturnTest: BaseTraceRepresentationTest("inlines/lambda_taken_deep_return") {
    var escape: Any? = null
    val i = 1
    ...
    override fun operation() {
        ...
        run r1@ {
            ...
            run r2@ {
                escape = "IN LAMBDA 2"
                if (!isFalse) return@r1
                escape = "UNREACHABLE 1"
            }
            escape = "UNREACHABLE 2"
        }
        escape = "END"
    }

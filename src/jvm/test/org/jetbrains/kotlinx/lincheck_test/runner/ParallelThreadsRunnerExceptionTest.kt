...
class ParallelThreadsRunnerExceptionTest {
    ...
    @Test
    fun testResumeWithException() = withLincheckJavaAgentAndLincheckTestLock(InstrumentationMode.STRESS) {
    ...
    @Test
    fun testThrowExceptionInFollowUp() = withLincheckJavaAgentAndLincheckTestLock(InstrumentationMode.STRESS) {
        val (scenario, expectedResults) = scenarioWithResults {
            parallel {
                thread {
                    operation(
    ...
    @Test
    fun testThrow() = withLincheckJavaAgentAndLincheckTestLock(InstrumentationMode.STRESS) {
        val (scenario, expectedResults) = scenarioWithResults {
            parallel {
                thread {
...
class ParallelThreadExecutionExceptionsTest {
    @Test
    fun shouldCompleteWithUnexpectedException() = withLincheckJavaAgentAndLincheckTestLock(InstrumentationMode.STRESS) {

package org.jetbrains.kotlinx.lincheck.test.distributed.guarantees
...
class AMOSender(private val environment: Environment, private val receiverId : Int){
...
class AMOReceiver(private val environment: Environment, private val senderId : Int) {

 ...
 */
internal class RandomSwitchOptions : Options<RandomSwitchOptions, RandomSwitchCTestConfiguration>() {
    protected var invocationsPerIteration = ModelCheckingCTestConfiguration.DEFAULT_INVOCATIONS

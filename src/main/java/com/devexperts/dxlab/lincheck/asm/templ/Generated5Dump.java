...
public class Generated5Dump implements Opcodes {
    ...
    public static byte[] dump (
        ...
        }
        {
            ...
            mv.visitIntInsn(SIPUSH, 4);
            mv.visitInsn(AALOAD);
            mv.visitMethodInsn(INVOKEVIRTUAL, testClassName, methodNames[4], "(Lcom/devexperts/dxlab/lincheck/util/Result;[Ljava/lang/Object;)V", false);
            mv.visitLabel(l13);
            Label l15 = new Label();

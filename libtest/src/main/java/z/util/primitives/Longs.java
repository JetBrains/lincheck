 ...
 * already found in either {@link Long} or {@link java.util.Arrays}.
 *
...
public final class Longs {
   ...
   * it is consistent with {@link java.util.Arrays#equals(long[], long[])}.
   *
  ...
  private static class LongArrayAsList extends AbstractList<Long>
    ...
    @Override public int hashCode() {
      int result = 1;
      for (int i = start; i < end; i++) {
        result = 31 * result + (int) (array[i] ^ (array[i] >>> 32));
      }
      return result;
    }
